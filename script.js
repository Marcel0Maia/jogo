...
function iniciar(){
    ...
    whitePiece[2] = new piece(coluna[4], linha[5], 0, 0, "white", 3);
    whitePiece[3] = new piece(coluna[6], linha[5], 0, 0, "white", 3);
    whitePiece[4] = new piece(coluna[1], linha[6], 0, 0, "white", 3);
    whitePiece[5] = new piece(coluna[3], linha[6], 0, 0, "white", 3);
    whitePiece[6] = new piece(coluna[5], linha[6], 0, 0, "white", 3);
    whitePiece[7] = new piece(coluna[7], linha[6], 0, 0, "white", 3);
    whitePiece[8] = new piece(coluna[0], linha[7], 0, 0, "white", 3);
    whitePiece[9] = new piece(coluna[2], linha[7], 0, 0, "white", 3);
    whitePiece[10] = new piece(coluna[4], linha[7], 0, 0, "white", 3);
    whitePiece[11] = new piece(coluna[6], linha[7], 0, 0, "white", 3);
}
